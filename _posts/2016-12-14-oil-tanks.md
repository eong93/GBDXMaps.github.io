...
You can run this notebook in a [GBDX notebook server](https://github.com/PlatformStories/gbdx-notebook). You can run the server locally on your machine or you can create your own [Jupyter Hub](https://github.com/PlatformStories/gbdx-jupyter-hub) to accommodate multiple users.    
